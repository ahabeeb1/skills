...
**Status:** Accepted — amended in place 2026-05-13 (v1.10.0): Part 3 gains the "share full traces" clause (Yan / Cognition AI); a new Part 5 codifies the treat-fetched-content-as-untrusted rule with 2026-05-13 prompt-injection evidence.
**Date:** 2026-05-12 (Proposed) → 2026-05-13 (Accepted — 4-status return contract consumed by v1.9.0 `verify-output` skill per ADR-0008) → 2026-05-13 (Amended — v1.10.0 Slice 2 adds Part 3 clause + Part 5)
