...
| ADR           | [`adrs/0022-behavioral-only-skill-body`](../adrs/0022-behavioral-only-skill-body.md) |
| Tier          | Balanced (inherited from spec)                                              |
| Status        | Done — v1.21.0 shipped 2026-05-26 (PR #46 merged; tag pushed)                |
...
- 2026-05-26 — v1.21.0 shipped. PR #46 merged into main as commit `ca53cb0`; tag `v1.21.0` pushed; GitHub release published at https://github.com/ahabeeb1/skills/releases/tag/v1.21.0. ADR renamed `adr-behavioral-only-skill-body.md` → `0022-behavioral-only-skill-body.md` via late-binding mechanism. All 13 dogfood scenarios pass on `main`. Status: Active → Done.
