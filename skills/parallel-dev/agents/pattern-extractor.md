...
- `skills/parallel-dev/agents/source-fetcher.md` — upstream producer of source records
- `skills/parallel-dev/agents/synthesizer.md` — downstream consumer of pattern records
